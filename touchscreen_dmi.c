...
static const struct property_entry winbook_tw102_props[] = {
	//	PROPERTY_ENTRY_U32("touchscreen-min-x", 9),
	//	PROPERTY_ENTRY_U32("touchscreen-min-y", 10),
	PROPERTY_ENTRY_U32("touchscreen-size-x", 1920),
	PROPERTY_ENTRY_U32("touchscreen-size-y", 1200),
	PROPERTY_ENTRY_BOOL("touchscreen-inverted-y"),
	//	PROPERTY_ENTRY_BOOL("touchscreen-swapped-x-y"),
	PROPERTY_ENTRY_STRING("firmware-name", "gsl1680-winbook-tw102.fw"),
	//	PROPERTY_ENTRY_U32("silead,max-fingers", 10),
	{ }
};

static const struct ts_dmi_data winbook_tw102_data = {
	.acpi_name      = "MSSL1680:00",
	.properties     = winbook_tw102_props,
};
...
static const struct dmi_system_id touchscreen_dmi_table[] = {
	...
	{
		/* Winbook TW102 */
		.driver_data = (void *)&winbook_tw102_data,
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "MicroElectronics"),
			DMI_MATCH(DMI_PRODUCT_NAME, "TW102"),
		},
	},
	{ },
};
